...
<details><summary><b><a href="https://github.com/thumbor-community/redis">tc_redis.storage</a></b> (🥈10 ·  ⭐ 10 · 📈) - Redis support. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/thumbor-community/redis) (👨‍💻 4 · 🔀 10 · 📋 4 - 75% open · ⏱️ 15.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/tc_redis) (📥 440 / month):
	```
	pip install tc_redis
	```
</details>
<details><summary><b><a href="https://github.com/thumbor/thumbor-aws">thumbor-aws S3 Storages and S3 Result Storage</a></b> (🥉9 ·  ⭐ 2 · 🐣) - thumbor-aws is a set of modern thumbor (7.0.0) AWS.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://www.python.org/downloads/"><code><img src="https://github.com/thumbor/awesome-thumbor/blob/main/python3.png?raw=true" style="display:inline;" width="13" height="13"></code></a> <a href="https://github.com/thumbor/thumbor/releases/tag/7.0.0"><code><img src="https://github.com/thumbor/awesome-thumbor/blob/main/thumbor.png?raw=true" style="display:inline;" width="13" height="13"></code></a></summary>
...
<details><summary><b><a href="https://github.com/thumbor/thumbor-aws">thumbor-aws S3 loader</a></b> (🥈9 ·  ⭐ 2 · 🐣) - thumbor-aws is a set of modern thumbor (7.0.0) AWS.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code> <a href="https://www.python.org/downloads/"><code><img src="https://github.com/thumbor/awesome-thumbor/blob/main/python3.png?raw=true" style="display:inline;" width="13" height="13"></code></a> <a href="https://github.com/thumbor/thumbor/releases/tag/7.0.0"><code><img src="https://github.com/thumbor/awesome-thumbor/blob/main/thumbor.png?raw=true" style="display:inline;" width="13" height="13"></code></a></summary>
...
- [GitHub](https://github.com/thumbor/thumbor-plugins) (👨‍💻 13 · 🔀 18 · 📋 13 - 15% open · ⏱️ 16.03.2022):

	```
	git clone https://github.com/thumbor/thumbor-plugins
	```
- [PyPi](https://pypi.org/project/thumbor-plugins-gifv) (📥 270 / month):
	```
...
- [GitHub](https://github.com/thumbor/thumbor-plugins) (👨‍💻 13 · 🔀 18 · 📋 13 - 15% open · ⏱️ 16.03.2022):
	...
	git clone https://github.com/thumbor/thumbor-plugins
	```
- [PyPi](https://pypi.org/project/thumbor-plugins-mozjpeg) (📥 210 / month):
	```
	pip install thumbor-plugins-mozjpeg
	```
</details>
<details><summary><b><a href="https://github.com/thumbor/thumbor-plugins">thumbor-plugins-jpegrecompress</a></b> (🥇15 ·  ⭐ 29 · 📈) - Optimizers and filters contributed by the Thumbor.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/thumbor/thumbor-plugins) (👨‍💻 13 · 🔀 18 · 📋 13 - 15% open · ⏱️ 16.03.2022):
	...
	git clone https://github.com/thumbor/thumbor-plugins
	```
- [PyPi](https://pypi.org/project/thumbor-plugins-jpegrecompress) (📥 190 / month):
	```
...
- [GitHub](https://github.com/thumbor/thumbor-plugins) (👨‍💻 13 · 🔀 18 · 📋 13 - 15% open · ⏱️ 16.03.2022):
	...
	git clone https://github.com/thumbor/thumbor-plugins
	```
- [PyPi](https://pypi.org/project/thumbor-plugins-pngcrush) (📥 220 / month):
	```
	pip install thumbor-plugins-pngcrush
	```
</details>
<details><summary><b><a href="https://github.com/thumbor/thumbor-plugins">thumbor-plugins-jp2</a></b> (🥇15 ·  ⭐ 29) - Optimizers and filters contributed by the Thumbor community. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/thumbor/thumbor-plugins) (👨‍💻 13 · 🔀 18 · 📋 13 - 15% open · ⏱️ 16.03.2022):
	...
	git clone https://github.com/thumbor/thumbor-plugins
	```
- [PyPi](https://pypi.org/project/thumbor-plugins-jp2) (📥 190 / month):
	```
	pip install thumbor-plugins-jp2
	```
</details>
<details><summary><b><a href="https://github.com/thumbor/thumbor-plugins">thumbor-plugins-optipng</a></b> (🥇15 ·  ⭐ 29) - Optimizers and filters contributed by the Thumbor.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/thumbor/thumbor-plugins) (👨‍💻 13 · 🔀 18 · 📋 13 - 15% open · ⏱️ 16.03.2022):
	...
	git clone https://github.com/thumbor/thumbor-plugins
	```
- [PyPi](https://pypi.org/project/thumbor-plugins-optipng) (📥 190 / month):
	```
...
- [GitHub](https://github.com/thumbor/thumbor-plugins) (👨‍💻 13 · 🔀 18 · 📋 13 - 15% open · ⏱️ 16.03.2022):
	...
	git clone https://github.com/thumbor/thumbor-plugins
	```
- [PyPi](https://pypi.org/project/thumbor-plugins-pngquant) (📥 200 / month):
	```
...
- [GitHub](https://github.com/ricobl/django-thumbor) (👨‍💻 7 · 🔀 20 · 📦 21 · 📋 10 - 10% open · ⏱️ 28.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-thumbor) (📥 3.4K / month):
	```
...
- [GitHub](https://github.com/Starou/django-thumborstorage) (👨‍💻 5 · 🔀 4 · 📦 5 · 📋 12 - 25% open · ⏱️ 08.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-thumborstorage) (📥 880 / month):
	```
...
- [GitHub](https://github.com/mayoreee/thumbor_dash) (👨‍💻 5 · 🔀 2 · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/thumbor_dash) (📥 880 / month):
	```
...
- [GitHub](https://github.com/vtex/faststore) (👨‍💻 58 · 🔀 16 · 📦 32 · 📋 270 - 21% open · ⏱️ 16.03.2022):

	```
	git clone https://github.com/vtex/faststore
	```
- [npm](https://www.npmjs.com/package/@vtex/gatsby-plugin-thumbor) (📥 10K / month):
	```
...
- [GitHub](https://github.com/abhilashlr/ember-thumbor-images) (👨‍💻 6 · 📋 3 - 66% open · ⏱️ 25.10.2021):
	...
	```
- [npm](https://www.npmjs.com/package/ember-thumbor-images) (📥 23 / month):
	```
