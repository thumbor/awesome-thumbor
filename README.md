...
- [GitHub](https://github.com/thumbor/thumbor-aws) (<span title="Contributors count from GitHub" alt="Contributors count from GitHub">👨‍💻 12</span> · <span title="Fork count from GitHub" alt="Fork count from GitHub">🔀 19</span>):
	...
	git clone https://github.com/thumbor/thumbor-aws
	```
- [PyPi](https://pypi.org/project/thumbor-aws) (<span title="Download count from package manager" alt="Download count from package manager">📥 3.1K / month</span> · <span title="Last update timestamp on package manager" alt="Last update timestamp on package manager">⏱️ 25.06.2026</span>):
	```
	pip install thumbor-aws
	```
</details>
...
- [GitHub](https://github.com/thumbor/remotecv) (<span title="Contributors count from GitHub" alt="Contributors count from GitHub">👨‍💻 25</span> · <span title="Fork count from GitHub" alt="Fork count from GitHub">🔀 33</span> · <span title="Number of dependent projects" alt="Number of dependent projects">📦 52</span>):
	...
	```
- [PyPi](https://pypi.org/project/remotecv) (<span title="Download count from package manager" alt="Download count from package manager">📥 4.5K / month</span> · <span title="Number of dependent projects" alt="Number of dependent projects">📦 3</span> · <span title="Last update timestamp on package manager" alt="Last update timestamp on package manager">⏱️ 16.03.2026</span>):
	```
