...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 170 · 🔀 750 · 📦 290 · 📋 860 - 10% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 6.9K / month · 📦 200 · ⏱️ 26.01.2022):
	```
	pip install thumbor
	```
</details>
...
- [GitHub](https://github.com/scorphus/thumbor-wand-engine) (👨‍💻 2 · 📋 5 - 20% open · ⏱️ 24.01.2022):

	```
	git clone https://github.com/scorphus/thumbor-wand-engine
	```
- [PyPi](https://pypi.org/project/thumbor-wand-engine) (📥 28 / month · ⏱️ 18.03.2021):
	```
...
- [GitHub](https://github.com/thumbor/remotecv) (👨‍💻 11 · 🔀 27 · 📦 24 · 📋 16 - 62% open · ⏱️ 26.01.2022):

	```
	git clone https://github.com/thumbor/remotecv
	```
- [PyPi](https://pypi.org/project/remotecv) (📥 1.3K / month · 📦 6 · ⏱️ 05.03.2020):
	```
...
- [GitHub](https://github.com/lanrenwo/thumbor_arcface) (⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/thumbor-arcface) (📥 34 / month · ⏱️ 31.03.2021):
	```
...
- [GitHub](https://github.com/globocom/thumbor-distributed-collage-filter) (👨‍💻 3 · 🔀 1 · ⏱️ 08.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/thumbor-distributed-collage-filter) (📥 24 / month · ⏱️ 01.06.2018):
	```
...
- [GitHub](https://github.com/ricobl/django-thumbor) (👨‍💻 7 · 🔀 20 · 📦 20 · 📋 10 - 20% open · ⏱️ 14.12.2021):

	```
	git clone https://github.com/ricobl/django-thumbor
	```
- [PyPi](https://pypi.org/project/django-thumbor) (📥 2.2K / month · 📦 7 · ⏱️ 10.12.2017):
	```
...
- [GitHub](https://github.com/vtex/faststore) (👨‍💻 58 · 🔀 14 · 📦 16 · 📋 280 - 25% open · ⏱️ 26.01.2022):

	```
	git clone https://github.com/vtex/faststore
	```
- [npm](https://www.npmjs.com/package/@vtex/gatsby-plugin-thumbor) (📥 12K / month · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/Brettm12345/thumbor-ts) (👨‍💻 5 · 🔀 1 · 📦 7 · 📋 3 - 66% open · ⏱️ 26.01.2022):

	```
	git clone https://github.com/Brettm12345/thumbor-ts
	```
- [npm](https://www.npmjs.com/package/thumbor-ts) (📥 910 / month · 📦 3 · ⏱️ 10.10.2020):
	```
...
- [GitHub](https://github.com/ytase/react-thumbor-img) (👨‍💻 6 · 🔀 4 · 📦 1 · ⏱️ 25.05.2021):
	...
	```
- [npm](https://www.npmjs.com/package/react-thumbor-img) (📥 1.8K / month · 📦 1 · ⏱️ 31.03.2021):
	```
...
- [GitHub](https://github.com/Michigan-Tech-Courses/thumbor) (👨‍💻 2 · 🔀 1 · 📦 1 · ⏱️ 09.09.2021):
	...
	```
- [npm](https://www.npmjs.com/package/@mtucourses/thumbor) (📥 770 / month · ⏱️ 09.09.2021):
	```
...
- [GitHub](https://github.com/handhead/thumbor-upload) (👨‍💻 2 · ⏱️ 15.02.2021):
	...
	```
- [npm](https://www.npmjs.com/package/thumbor-upload) (📥 4 / month · ⏱️ 15.02.2021):
	```
...
<details><summary><b><a href="https://github.com/square/pollexor">pollexor</a></b> (🥇19 ·  ⭐ 620 · 📈) - Java client for the Thumbor image service which allows.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> <code><img src="https://www.java.com/favicon.ico" style="display:inline;" width="13" height="13"></code> <a href="https://github.com/thumbor/thumbor/releases/tag/7.0.0"><code><img src="https://github.com/thumbor/awesome-thumbor/blob/main/thumbor.png?raw=true" style="display:inline;" width="13" height="13"></code></a></summary>

- [GitHub](https://github.com/square/pollexor) (👨‍💻 15 · 🔀 89 · 📋 12 - 16% open · ⏱️ 24.01.2022):
